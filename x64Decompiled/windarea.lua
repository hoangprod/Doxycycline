...
function WindArea:PhysicalizeThis()
  if self.bActive == 1 then
    ...
    if Properties.bEllipsoidal == 1 or 1 > Properties.FalloffInner then
    ...
    if Properties.Dir.x == 0 and Properties.Dir.y == 0 and Properties.Dir.z == 0 then
      ...
      Area.uniform = 2
      Area.wind = {
        x = Properties.Dir.x * Properties.Speed,
        y = Properties.Dir.y * Properties.Speed,
        z = Properties.Dir.z * Properties.Speed
      }
    end
