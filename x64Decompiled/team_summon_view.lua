function SetViewOfTeamSummon(id, parent)
  ...
  question:SetText(GetCommonText("team_summon_question"))
  ...
  notice:SetText(GetCommonText("team_summon_notice"))
  ...
  local summonItem = wnd:CreateChildWidget("label", "summonItem", 0, true)
  summonItem:SetExtent(width, FONT_SIZE.XLARGE)
  summonItem.style:SetFontSize(FONT_SIZE.XLARGE)
  summonItem:AddAnchor("TOP", bg, "TOP", 0, 25)
  summonItem:SetText(GetCommonText("summon_item"))
  ApplyTextColor(summonItem, FONT_COLOR.TITLE)
  wnd.itemIcon = CreateItemIconButton("itemIcon", wnd)
  wnd.itemIcon:AddAnchor("TOP", summonItem, "BOTTOM", 0, MARGIN.WINDOW_SIDE / 2)
...
function SetViewOfTeamSummonSuggest(id, parent)
  local wnd = CreateWindow(id, parent)
  ...
  question:SetAutoResize(true)
  question.style:SetFontSize(FONT_SIZE.LARGE)
  question:SetText(GetCommonText("team_summon_move"))
  question:AddAnchor("TOP", wnd, 0, MARGIN.WINDOW_TITLE)
  ApplyTextColor(question, FONT_COLOR.TITLE)
  local notice = wnd:CreateChildWidget("textbox", "notice", 0, true)
